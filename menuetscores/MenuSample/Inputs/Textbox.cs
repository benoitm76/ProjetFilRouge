...
namespace FileRouge.Inputs
{
            ...
            characterByKey = new Dictionary<Keys, char>()
    {
        ...
        {
            spriteBatch.Begin();
            Vector2 tailletext = font.MeasureString("test");
            spriteBatch.Draw(dummyTexture, new Rectangle((int)Position.X, (int)Position.Y, 400, (int)tailletext.Y), Color.White);
            spriteBatch.DrawString(
                font, Text,
                Position, ForegroundColor);
            spriteBatch.End();
        }
